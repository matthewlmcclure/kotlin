...
import org.jetbrains.kotlin.ir.backend.js.Lowering
...
object CodegenTestDirectives : SimpleDirectivesContainer() {
    ...
    val DUMP_IR_FOR_GIVEN_PHASES by stringDirective(//valueDirective<AnyNamedPhase>(
        description = "Dumps backend IR after given lowerings (enables ${PhasedJvmIrDumpHandler::class})",
