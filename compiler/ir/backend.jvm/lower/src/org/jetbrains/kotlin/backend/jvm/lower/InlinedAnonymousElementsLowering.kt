...
class InlinedAnonymousElementsLowering(val context: JvmBackendContext) : IrElementTransformerVoid(), FileLoweringPass {
    ...
    override fun visitClass(declaration: IrClass): IrStatement {
        if (inlineStack.isEmpty() || declaration.attributeOwnerIdBeforeInline != null || declaration.isDeclaredOnCallSite()) {
            ...
            // third check is needed to remove copied from callee site declarations because they will be generated by compiler once
    ...
    private fun IrAttributeContainer.isDeclaredOnCallSite(): Boolean {
        ...
        val declaration = when (val original = this.attributeOwnerId) {
            ...
            is IrFunctionReference -> return true // `inlinedVarStack.isEmpty()` ensures that this references was declared on call site
            else -> return false
        }
